...
/**
 * Allows different operations for handling content data.
 * 
 * @author Ireth
 */
public final class ContentHandler {
	...
	public static Data reorderCols(Data data, int[] colOrder) throws ApplicationException {
		...
		List<DataCell[]> content = data.getImmutableContent();
	...
	private static void validate(boolean throwExc, DataModelMessageKey key, Object... params) throws ApplicationException {
		if (throwExc) {
